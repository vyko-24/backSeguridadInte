...
public class initialConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        User userResponsable2 = getOrSaveUser(new User( "nuevo@gmail.com","Cris","Sanchez","NewUser",encoder.encode("1234"),responsable, true));
        User userBlocked = getOrSaveUser(new User( "bloqueado@gmail.com","Cris","Sanchez","BlockedUser",encoder.encode("1234"),responsable, false));
